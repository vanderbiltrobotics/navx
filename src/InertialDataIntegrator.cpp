...
void InertialDataIntegrator::UpdateDisplacement(float accel_x_g, float accel_y_g, int update_rate_hz, bool is_moving)
{
    if (is_moving) {
        float accel_g[2];
        float accel_m_s2[2];
...
float InertialDataIntegrator::GetVelocityX() { return last_velocity[0]; }

float InertialDataIntegrator::GetVelocityY() { return last_velocity[1]; }

float InertialDataIntegrator::GetVelocityZ() { return 0; }

float InertialDataIntegrator::GetDisplacementX() { return displacement[0]; }

float InertialDataIntegrator::GetDisplacementY() { return displacement[1]; }

float InertialDataIntegrator::GetDisplacementZ() { return 0; }
